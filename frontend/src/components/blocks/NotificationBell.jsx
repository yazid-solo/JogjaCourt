...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 w-[92vw] sm:absolute sm:top-full sm:left-auto sm:right-0 sm:transform-none sm:translate-x-0 sm:mt-2 sm:w-96 bg-[#111] border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-[150]">
