  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6 sm:space-y-8 max-w-7xl mx-auto pb-24 md:pb-12 px-2 sm:px-0">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 relative">
        ...
        <div className="w-full bg-gradient-to-br from-[#D4AF37] to-yellow-500 rounded-3xl p-6 md:p-8 relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(212,175,55,0.3)] transition-all duration-500 sm:col-span-2 md:col-span-1 hover:-translate-y-1">
        ...
        <div className="w-full bg-[#0a0a0a] border border-white/5 rounded-3xl p-6 md:p-8 relative overflow-hidden group hover:border-emerald-500/30 transition-all hover:shadow-[0_15px_40px_rgba(16,185,129,0.15)] hover:-translate-y-1">
        ...
        {/* Card 3: Platform Fee */}
        <div className="w-full bg-[#0a0a0a] border border-white/5 rounded-3xl p-6 md:p-8 relative overflow-hidden group hover:border-red-500/30 transition-all hover:shadow-[0_15px_40px_rgba(239,68,68,0.15)] hover:-translate-y-1">
